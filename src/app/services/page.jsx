      ...
      <div className="flex mt-4 justify-start items-stretch flex-row flex-wrap gap-4">
        ...
        <Link href={"/services/interest-ocr"}>
          <ServiceCard
            title={"Interest OCR"}
            content={
              "The Interest OCR service is a specialized solution designed to extract and verify financial data related to interest income, tax deductions, and investment-related details. This efficient service automates the capture of critical interest-related data from financial documents, ensuring accuracy and compliance with tax regulations. By transforming unstructured financial data into structured formats, it facilitates seamless integration with financial and accounting systems."
            }
          />
        </Link>
        <Link href={"/services/divident-ocr"}>
          <ServiceCard
            title={"Divident OCR"}
            content={
              "The Dividend OCR service is an advanced solution designed to verify and extract data from dividend statements and tax documents. This comprehensive service automates the capture of essential financial details, ensuring accuracy and compliance with tax regulations. By transforming dividend-related data into structured formats, it facilitates seamless integration with financial and accounting systems."
            }
          />
        </Link>
      </div>
